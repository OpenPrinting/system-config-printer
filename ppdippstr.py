...
def init ():
    ...
    ppd = TranslationDict ({
            ...
            "Media Type": _("Media Type"),
                ...
                "Plain": _("Plain"),
                "Plain paper": _("Plain paper"),
                "Plain/Recycled": _("Plain/Recycled"),
            ...
            #Gutenprint
	    "Inverted Grayscale": _("Inverted Grayscale"),
	    "RGB Color": _("RGB Color"),
	    "CMY Color": _("CMY Color"),
	    "Transparencies": _("Transparencies"),
	    "High Resolution Paper": _("High Resolution Paper"),
	    "Glossy Photo Paper": _("Glossy Photo Paper"),
	    "Glossy Photo Cards": _("Glossy Photo Cards"),
	    "Photo Paper Pro": _("Photo Paper Pro"),
	    "Other": _("Other"),
            "Postcard": _("Postcard"),
	    "High": _("High"),
	    "Manual": _("Manual"),
	    "Manual Control": _("Manual Control"),
	    "Manual - Movable Guides": _("Manual - Movable Guides"),
	    "Tray 1 - Movable Guides": _("Tray 1 - Movable Guides"),
	    "Tray 2 - Movable Guides": _("Tray 2 - Movable Guides"),
	    "Tray 3 - Movable Guides": _("Tray 3 - Movable Guides"),
	    "Tray 4 - Movable Guides": _("Tray 4 - Movable Guides"),
	    ...
	    "Mixed Text and Graphics": _("Mixed Text and Graphics"),
	    "Text": _("Text"),
	    "Graphics": _("Graphics"),
	...
	"Output Control Extra 1": _("Output Control Extra 1"),
            "Density": _("Density"),
            "Density Fine Adjustment": _("Density Fine Adjustment"),
	"Output Control Extra 2": _("Output Control Extra 2"),
            "Cyan": _("Cyan"),
            "Yellow": _("Yellow"),
            "Black": _("Black"),
            "Magenta": _("Magenta"),
	"Output Control Extra 4": _("Output Control Extra 4"),

            #Foomatic
	    "Bidirectional printing": _("Bidirectional printing"),
            "US Letter": _("US Letter"),
            "On (Flip on Long Edge)": _("On (Flip on Long Edge)"),
            "On (Flip on Short Edge)": _("On (Flip on Short Edge)"),
            # Options 
	    ...
	    "Orientation": _("Orientation"),
            "Printer Features Extra 1": _("Printer Features Extra 1"),
           ...
           "Paper Destination": _("Paper Destination"),
            ...
            #Samsung
            "Staple Position": _("Staple Position"),
               "Left": _("Left"),
               "Right": _("Right"),
               "Top": _("Top"),
            "Punch Position": _("Punch Position"),
                "Printer Auto Selection": _("Printer Auto Selection"),
                "Multi-Purpose Tray": _("Multi-Purpose Tray"),
            ...
            "Staple": _("Staple"),
                ...
                "2 at left": _("2 at left"),
                "2 at right": _("2 at right"),
                "2 at top": _("2 at top"),
                "2 at center": _("2 at center"),
            "Punch": _("Punch"),
                "2 at left (Japan/Europe)": _("2 at left (Japan/Europe)"),
                "2 at left (North America)": _("2 at left (North America)"),
                "3 at left (North America)": _("3 at left (North America)"),
                "4 at left (Europe)": _("4 at left (Europe)"),
                "4 at left (Northern Europe)": _("4 at left (Northern Europe)"),
		"2 at right (Japan/Europe)": _("2 at right (Japan/Europe)"),
                "2 at right (North America)": _("2 at right (North America)"),
                "3 at right (North America)": _("3 at right (North America)"),
                "4 at right (Europe)": _("4 at right (Europe)"),
                "4 at right (Northern Europe)": _("4 at right (Northern Europe)"),
                "2 at top (Japan/Europe)": _("2 at top (Japan/Europe)"),
                "2 at top (North America)": _("2 at top (North America)"),
                "3 at top (North America)": _("3 at top (North America)"),
                "4 at top (Europe)": _("4 at top (Europe)"),
                "4 at top (Northern Europe)": _("4 at top (Northern Europe)"),
    ...
    ## Kyocera
                "Flip on Short Edge": _("Flip on Short Edge"),
                "Flip on Long Edge": _("Flip on Long Edge"),
                "Booklet": _("Booklet"),
                "Offset": _("Offset"),
